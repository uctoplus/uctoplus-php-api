...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://localhost/production';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/4.0.1/PHP';
    ...
    {
        $report  = 'PHP SDK (Uctoplus\API) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 4.0.1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "{portal_api_url}/production",
                "description" => "Production server",
            ],
            [
                "url" => "{portal_api_url}/sandbox",
