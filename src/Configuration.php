...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://moje.uctoplus.sk/api/v2/production';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.0.2' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://moje.uctoplus.sk/api/v2/production",
                "description" => "Production server",
            ],
            [
                "url" => "https://moje.uctoplus.sk/api/v2/sandbox",
