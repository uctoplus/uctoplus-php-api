...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://moje.uctoplus.sk/api/v3/production';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 3.1.1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://moje.uctoplus.sk/api/v3/production",
                "description" => "Production server",
            ],
            [
                "url" => "https://moje.uctoplus.sk/api/v3/sandbox",
