...
class InvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('send_via_peppol', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets logo_version
     *
     * @param int|null $logo_version ID from [{portal_name}]({portal_url})
     *
     * @return self
     */
     ...
     *
     * @param int|null $signature_version ID from [{portal_name}]({portal_url})
     *
     * @return self
     */
     ...
     * Sets delivery_type
     *
     * @param int|null $delivery_type ID from [{portal_name}]({portal_url})
     *
     * @return self
     */
     ...
     *
     * @param bool|null $send_via_peppol send_via_peppol
     *
     * @return self
     */
    public function setSendViaPeppol($send_via_peppol)
    {
        if (is_null($send_via_peppol)) {
            throw new \InvalidArgumentException('non-nullable send_via_peppol cannot be null');
        }
