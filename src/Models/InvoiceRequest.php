...
class InvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reciever'] = $data['reciever'] ?? null;
        $this->container['delivery_address'] = $data['delivery_address'] ?? null;
        $this->container['internal_description'] = $data['internal_description'] ?? null;
        $this->container['variable_symbol'] = $data['variable_symbol'] ?? null;
        $this->container['konstantny_symbol'] = $data['konstantny_symbol'] ?? null;
        $this->container['specificky_symbol'] = $data['specificky_symbol'] ?? null;
        $this->container['date_issue'] = $data['date_issue'] ?? null;
        ...
        $this->container['note1'] = $data['note1'] ?? null;
        $this->container['note2'] = $data['note2'] ?? null;
        $this->container['note3'] = $data['note3'] ?? null;
        $this->container['theme'] = $data['theme'] ?? null;
        $this->container['logo_version'] = $data['logo_version'] ?? null;
        $this->container['signature_version'] = $data['signature_version'] ?? null;
        ...
        $this->container['currency2'] = $data['currency2'] ?? null;
        $this->container['items'] = $data['items'] ?? null;
        $this->container['tags'] = $data['tags'] ?? null;
        $this->container['reverse_charge'] = $data['reverse_charge'] ?? false;
