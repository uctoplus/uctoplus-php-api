...
class InvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets logo_version
     *
     * @param int|null $logo_version ID from [Účto+]({portal_url})
     *
     * @return self
     */
     ...
     *
     * @param int|null $signature_version ID from [Účto+]({portal_url})
     *
     * @return self
     */
     ...
     * Sets delivery_type
     *
     * @param int|null $delivery_type ID from [Účto+]({portal_url})
     *
     * @return self
     */
