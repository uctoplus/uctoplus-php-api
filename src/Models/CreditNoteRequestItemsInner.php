...
/**
 * CreditNoteRequestItemsInner Class Doc Comment
 *
 * @category Class
 * @package  Uctoplus\API
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteRequestItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteRequest_items_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tax_percentage', $data ?? [], 0.0);
