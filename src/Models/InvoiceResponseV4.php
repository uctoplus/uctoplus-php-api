...
/**
 * InvoiceResponseV4 Class Doc Comment
 *
 * @category Class
 * @package  Uctoplus\API
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceResponseV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceResponseV4';
    ...
    protected static $openAPITypes = [
        ...
        'reciever' => '\Uctoplus\API\Models\AddressResponseV4',
        'delivery_address' => '\Uctoplus\API\Models\DeliveryAddressResponseV4',
        ...
        'currency2' => '\Uctoplus\API\Models\InvoiceResponseV4Currency2',
    ...
    */
     ...
     * Sets reciever
     *
     * @param \Uctoplus\API\Models\AddressResponseV4|null $reciever reciever
     *
     * @return self
     */
     ...
     *
     * @return \Uctoplus\API\Models\DeliveryAddressResponseV4|null
     */
     ...
     *
     * @param \Uctoplus\API\Models\DeliveryAddressResponseV4|null $delivery_address delivery_address
     *
     * @return self
     */
     ...
     * Sets template_id
     *
     * @param int|null $template_id ID from [{portal_name}]({portal_url})
     *
     * @return self
     */
     ...
     * Gets currency2
     *
     * @return \Uctoplus\API\Models\InvoiceResponseV4Currency2|null
     */
     ...
     * Sets currency2
     *
     * @param \Uctoplus\API\Models\InvoiceResponseV4Currency2|null $currency2 currency2
     *
     * @return self
     */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling InvoiceResponseV4., number of items must be greater than or equal to 1.');
        }
    ...
    {
        return $this->container['file_xml'];
    }

    /**
     * Sets file_xml
     *
     * @param \Uctoplus\API\Models\File|null $file_xml file_xml
     *
     * @return self
     */
    public function setFileXml($file_xml)
    {
        if (is_null($file_xml)) {
            array_push($this->openAPINullablesSetToNull, 'file_xml');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('file_xml', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['file_xml'] = $file_xml;
     ...
     * Gets peppol_status
     *
     * @return \Uctoplus\API\Models\PeppolStatus|null
     */
    public function getPeppolStatus()
    {
        return $this->container['peppol_status'];
    }

    /**
     * Sets peppol_status
     *
     * @param \Uctoplus\API\Models\PeppolStatus|null $peppol_status peppol_status
     *
     * @return self
     */
    public function setPeppolStatus($peppol_status)
    {
        if (is_null($peppol_status)) {
            throw new \InvalidArgumentException('non-nullable peppol_status cannot be null');
        }
        $this->container['peppol_status'] = $peppol_status;
