...
class Payment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('total_payed', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_payed'] === null && !$this->isNullableSetToNull('total_payed')) {
     ...
     * Sets total_payed
     *
     * @param float|null $total_payed total_payed
     *
     * @return self
     */
    public function setTotalPayed($total_payed)
    {
        if (is_null($total_payed)) {
            array_push($this->openAPINullablesSetToNull, 'total_payed');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('total_payed', $nullablesSetToNull);
            if ($index !== FALSE) {
