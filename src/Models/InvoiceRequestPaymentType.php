...
/**
 * InvoiceRequestPaymentType Class Doc Comment
 *
 * @category Class
 * @description If filled new PaymentType it will be created!
 * @package  Uctoplus\API
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InvoiceRequestPaymentType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceRequest_paymentType';
    ...
    */
    ...
    public function setInvoiceDescription($invoice_description)
    {
        if (is_null($invoice_description)) {
            array_push($this->openAPINullablesSetToNull, 'invoice_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invoice_description', $nullablesSetToNull);
            if ($index !== FALSE) {
