...
/**
     ...
     */
    public function addInvoice($add_invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        list($response) = $this->addInvoiceWithHttpInfo($add_invoice_request, $contentType);
        return $response;
    }
     ...
     */
    public function addInvoiceWithHttpInfo($add_invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        $request = $this->addInvoiceRequest($add_invoice_request, $contentType);
     ...
     */
    public function addInvoiceAsync($add_invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        return $this->addInvoiceAsyncWithHttpInfo($add_invoice_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addInvoiceAsyncWithHttpInfo($add_invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        $returnType = '\Uctoplus\API\Models\AddInvoice200Response';
        $request = $this->addInvoiceRequest($add_invoice_request, $contentType);
     ...
     */
    public function addInvoiceRequest($add_invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
