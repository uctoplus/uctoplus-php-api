...
/**
     ...
     */
    public function addInvoice($invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        list($response) = $this->addInvoiceWithHttpInfo($invoice_request, $contentType);
        return $response;
    }
     ...
     */
    public function addInvoiceWithHttpInfo($invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        $request = $this->addInvoiceRequest($invoice_request, $contentType);
     ...
     */
    public function addInvoiceAsync($invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        return $this->addInvoiceAsyncWithHttpInfo($invoice_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addInvoiceAsyncWithHttpInfo($invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        $returnType = '\Uctoplus\API\Models\AddInvoice200Response';
        $request = $this->addInvoiceRequest($invoice_request, $contentType);
     ...
     */
    public function addInvoiceRequest($invoice_request, string $contentType = self::contentTypes['addInvoice'][0])
    {
        ...
        if (isset($invoice_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($invoice_request));
            } else {
     ...
     * @return \Uctoplus\API\Models\AddInvoice200Response|\Uctoplus\API\Models\ResponseContentERROR|\Uctoplus\API\Models\ResponseContentERROR|\Uctoplus\API\Models\ResponseContentERROR|\Uctoplus\API\Models\ResponseContentERROR|\Uctoplus\API\Models\ResponseContentERROR
     */
    public function addPaymentToInvoice($id, $payment, string $contentType = self::contentTypes['addPaymentToInvoice'][0])
    {
        list($response) = $this->addPaymentToInvoiceWithHttpInfo($id, $payment, $contentType);
        return $response;
    }
     ...
     * @return array of \Uctoplus\API\Models\AddInvoice200Response|\Uctoplus\API\Models\ResponseContentERROR|\Uctoplus\API\Models\ResponseContentERROR|\Uctoplus\API\Models\ResponseContentERROR|\Uctoplus\API\Models\ResponseContentERROR|\Uctoplus\API\Models\ResponseContentERROR, HTTP status code, HTTP response headers (array of strings)
     */
    public function addPaymentToInvoiceWithHttpInfo($id, $payment, string $contentType = self::contentTypes['addPaymentToInvoice'][0])
    {
        $request = $this->addPaymentToInvoiceRequest($id, $payment, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addPaymentToInvoiceAsync($id, $payment, string $contentType = self::contentTypes['addPaymentToInvoice'][0])
    {
        return $this->addPaymentToInvoiceAsyncWithHttpInfo($id, $payment, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addPaymentToInvoiceAsyncWithHttpInfo($id, $payment, string $contentType = self::contentTypes['addPaymentToInvoice'][0])
    {
        $returnType = '\Uctoplus\API\Models\AddInvoice200Response';
        $request = $this->addPaymentToInvoiceRequest($id, $payment, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function addPaymentToInvoiceRequest($id, $payment, string $contentType = self::contentTypes['addPaymentToInvoice'][0])
    {
