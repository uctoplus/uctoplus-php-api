...
class AddressListApi
{
     ...
     * @return \Uctoplus\API\Models\Response|\Uctoplus\API\Models\ErrorModel
     */
     ...
     * @throws \Uctoplus\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uctoplus\API\Models\Response|\Uctoplus\API\Models\ErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function addAddressWithHttpInfo($address)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uctoplus\API\Models\Response' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uctoplus\API\Models\Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Uctoplus\API\Models\ErrorModel' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uctoplus\API\Models\ErrorModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uctoplus\API\Models\Response';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uctoplus\API\Models\ErrorModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Uctoplus\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uctoplus\API\Models\Address
     */
     ...
     * @throws \Uctoplus\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uctoplus\API\Models\Address, HTTP status code, HTTP response headers (array of strings)
     */
