...
| ------------- | ------------- | ------------- |
| [**addInvoice()**](V3Api.md#addInvoice) | **POST** /v3/invoice/add | addInvoice |
| [**addPaymentToInvoice()**](V3Api.md#addPaymentToInvoice) | **POST** /v3/invoice/{id}/pay | addPaymentToInvoice |
| [**getInvoice()**](V3Api.md#getInvoice) | **GET** /v3/invoice/{id}/get | getInvoice |
| [**sendInvoice()**](V3Api.md#sendInvoice) | **POST** /v3/invoice/{id}/send | sendInvoice |
| [**uploadFile()**](V3Api.md#uploadFile) | **POST** /v3/upload/add | Uploading files over RestAPI |
| [**uploadedFilesIndex()**](V3Api.md#uploadedFilesIndex) | **GET** /v3/upload/index | uploadFile |
...
$apiInstance = new Uctoplus\API\Api\V3Api(
...
try {
    ...
    echo 'Exception when calling V3Api->addInvoice: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling V3Api->addPaymentToInvoice: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling V3Api->getInvoice: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling V3Api->sendInvoice: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling V3Api->uploadFile: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling V3Api->uploadedFilesIndex: ', $e->getMessage(), PHP_EOL;
}
```
