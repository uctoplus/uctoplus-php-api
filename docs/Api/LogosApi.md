...
| ------------- | ------------- | ------------- |
| [**getLogos()**](LogosApi.md#getLogos) | **GET** /v2/dial/logos | getLogos |
...
$apiInstance = new Uctoplus\API\Api\LogosApi(
...
try {
    ...
    echo 'Exception when calling LogosApi->getLogos: ', $e->getMessage(), PHP_EOL;
}
```
