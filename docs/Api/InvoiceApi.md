...
| [**importInvoiceV4()**](InvoiceApi.md#importInvoiceV4) | **POST** /v4/invoice/import | importInvoiceV4 |
...
try {
    ...
    echo 'Exception when calling InvoiceApi->importInvoiceV4: ', $e->getMessage(), PHP_EOL;
}
```
