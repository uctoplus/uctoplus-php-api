# Uctoplus\API\InvoiceTemplatesApi

All URIs are relative to https://api.moje.uctoplus.sk/production, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**getTemplates()**](InvoiceTemplatesApi.md#getTemplates) | **GET** /v2/dial/invoice/templates | getTemplates |
...
$apiInstance = new Uctoplus\API\Api\InvoiceTemplatesApi(
...
try {
    ...
    echo 'Exception when calling InvoiceTemplatesApi->getTemplates: ', $e->getMessage(), PHP_EOL;
}
```
